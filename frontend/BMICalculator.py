...
def setup(root, tk):
    ...
    disclaimer1 = tk.Label(root, text="DISCLAIMER: For accurate health info,", font=("Helvetica", 10), fg="red",justify="center")
    disclaimer1.grid(column=1, row=1, sticky="s")
    disclaimer2 = tk.Label(root, text="PLEASE speak to your doctor.", font=("Helvetica", 10), fg="red",justify="center")
    ...
    calculate_btn = tk.Button(root, text="Calculate BMI", command=lambda: calculateBMI(height_var.get(), weight_var.get(), root))
